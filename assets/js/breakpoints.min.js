                    ...
                    if (Array.isArray(i)) {
                        ...
                        if (isNaN(r)) {
                            switch (a) {
                                ...
                                default: s = "screen and (max-width: " + d + c + ")"; break;
                            }
                        } else if (isNaN(d)) {
                            switch (a) {
                                ...
                                default: s = "screen and (min-width: " + r + c + ")"; break;
                            }
                        } else {
                            switch (a) {
                                case "gte": s = "screen and (min-width: " + r + c + ")"; break;
                                ...
                                default: s = "screen and (min-width: " + r + c + ") and (max-width: " + d + c + ")"; break;
                            }
                        }
                    } else {
...
// Module export for compatibility with various module loaders
(function (e, t) {
